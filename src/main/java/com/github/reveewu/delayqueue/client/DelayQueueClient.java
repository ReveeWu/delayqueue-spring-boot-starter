package com.github.reveewu.delayqueue.client;

import com.github.reveewu.delayqueue.core.*;
import com.github.reveewu.delayqueue.common.ServiceThread;
import com.github.reveewu.delayqueue.common.ThreadFactoryImpl;
        ...
        public void run() {
            while (!this.isStoped()) {
                try {
                    ...
                    log.warn("拉取延时队列消息出错, topic: {}", topic, e);
                    // 如果出错或没有数据，休眠1秒
                    try {
                        Thread.sleep(1000);
